''''Author: Chrystia Siolkowsky + Stephen Wagner
''''Release 1.3
...
''''Change Log v1.3
'Fixed error in naming duplicated bone "RightHandMiddle3" -Steve
...
'-------------------------------------------
SetValue "LeftMiddleRoot1.Name,LeftMiddleRoot1.LeftHandMiddle4.Name,LeftHandMiddle4.LeftHandMiddle5.Name,LeftHandMiddle5.LeftHandMiddle6.name,LeftMiddleRoot1.LeftMiddleEffector1.Name.", Array("RightMiddleRoot", "RightHandMiddle1", "RightHandMiddle1", "RightHandMiddle1", "RightMiddleEffector")
