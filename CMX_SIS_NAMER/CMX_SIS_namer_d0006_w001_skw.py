...
This is the next planned change. Added a button to "flip" a recently duplicated
object with an "l_" or "r_" prefix to the opposite side."""

"""TO DO:
Null: embed the custom property into the root null, rather than a null in the scene
    OR!!!! hide the null that gets created!
